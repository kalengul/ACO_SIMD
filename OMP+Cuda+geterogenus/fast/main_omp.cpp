...
public:
    ...
    int get_hash_fails() const { return 0; }
    double get_time_cpu_all() const { return 0; }
    double get_time_cpu_prob() const { return 0; }
    double get_time_cpu_wait() const { return 0; }
    double get_time_cpu_update() const { return 0; }
    double get_time_gpu_all() const { return 0; }
    double get_time_gpu() const { return 0; }
    double get_time_gpu_function() const { return 0; }
