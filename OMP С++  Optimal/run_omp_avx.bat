...
g++ -std=c++17 -fopenmp -O3 -mavx2 -mfma -march=native -o omp_avx_optimized.exe OMP_AVX_C++.cpp
clang++ -std=c++17 -fopenmp -O3 -mavx2 -mfma -march=native -o omp_avx_optimized_clang.exe OMP_AVX_C++.cpp
