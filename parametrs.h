...
#define GO_CUDA_ANT_ADD_CPU_AVX_TIME_4_NOT_F 1 // работает только при 100 агентах
...
#define GO_CUDA_ANT_DECREASE_PAR_CONST 1
#define GO_CUDA_ANT_DECREASE_PAR_BLOCK_CONST 1
#define GO_CUDA_ANT_DECREASE_ANT_CONST 1
#define GO_CUDA_ANT_DECREASE_ANT_BLOCK_CONST 1
#define GO_CUDA_ANT_DECREASE_ANT_PAR_CONST 1
#define GO_CUDA_ANT_DECREASE_ANT_PAR_TRANSP_CONST 1

#define GO_CUDA_ANT_PAR_NOT_F 1
#define GO_CUDA_ANT_PAR_SORT 1
/*
#define GO_CUDA 1 
#define GO_CUDA_TIME 1 
#define GO_CUDA_NON_HASH 1 
...
#ifndef BLOCK_SIZE
#define BLOCK_SIZE 256 // или оптимальный размер для вашего GPU
#endif
