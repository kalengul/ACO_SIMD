...
g++ -O3 -fopenmp -march=native OMP_C++.cpp -o OMP_gcc.exe
...
clang++ -fopenmp -fopenmp-version=31 -mavx -O3 -march=native OMP_C++.cpp -o OMP_clang_31.exe

echo.
echo 5. Clang OpenMP 4.0:
clang++ -fopenmp -fopenmp-version=40 -mavx -O3 -march=native OMP_C++.cpp -o OMP_clang_40.exe

echo.
echo 6. Clang OpenMP 4.5:
clang++ -fopenmp=libomp -fopenmp-version=45 -mavx -O3 -march=native OMP_C++.cpp -o OMP_clang_45.exe

echo.
echo 7. Clang OpenMP 5.0:
clang++ -fopenmp -fopenmp-version=50 -mavx -O3 -march=native OMP_C++.cpp -o OMP_clang_50.exe

echo.
echo 8. Clang OpenMP 5.1:
clang++ -fopenmp -fopenmp-version=51 -mavx -O3 -march=native OMP_C++.cpp -o OMP_clang_51.exe

echo.
echo 9. Clang OpenMP 5.2:
clang++ -fopenmp -fopenmp-version=52 -mavx -O3 -march=native OMP_C++.cpp -o OMP_clang_52.exe

echo.
echo 10. Clang OpenMP 6.0:
clang++ -fopenmp -fopenmp-version=60 -mavx -O3 -march=native OMP_C++.cpp -o OMP_clang_60.exe

echo.
echo ========== PERFORMANCE TEST ==========
echo Running performance tests...

if exist OMP_clang_31.exe (
    echo.
